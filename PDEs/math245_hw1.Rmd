...
Now define our new coordinate system as $xi=\frac{x}{2}+\frac{\ln x}{2}-y, \quad \eta=x$.  
Then by the chain rule,
$$u_x= \pdv{u}{x}=\pdv{u}{\eta}\pdv{\eta}{x}+\pdv{u}{\xi}\pdv{\xi}{x}=$$
$$\pdv{u}{\xi}\left(\frac{1}{2}+ \frac{1}{2x}\right) +\pdv{u}{\eta}$$
$$u_y= \pdv{u}{y}=\pdv{u}{\eta}\pdv{\eta}{y}+\pdv{u}{\xi}\pdv{\xi}{y}= -\pdv{u}{\xi}$$
Plugging these into our original PDE,
$$2x\left( \pdv{u}{\xi}\left(\frac{1}{2}+ \frac{1}{2x}\right) +\pdv{u}{\eta} \right)+\left(x+1\right)\left(-\pdv{u}{\xi}\right)=$$
$$\pdv{u}{\xi}\left(x+1\right)+2x \pdv{u}{\eta}-\pdv{u}{\xi}\left(x+1\right)=2x \pdv{u}{\eta}$$
So we must have $2x\pdv{u}{\eta}=y$. Now replace $\eta$ and $\xi$ by $x$ and $y$:
$$2\eta\pdv{u}{\eta}=\frac{\eta}{2}+\frac{\ln\eta}{2}-\xi$$

$$\pdv{u}{\eta}=\frac{1}{4}+\frac{\ln\eta}{4\eta}-\frac{\xi}{2n}$$

Now integrate with respect to $\eta$:
$$u=\frac{\eta}{4}+\frac{(\ln\eta)^2}{8}-\frac{\xi \ln\eta}{2}+F(\xi)$$

...
Now we define our new coordinate system as $2y-x-\ln(x), \, \eta=x$  

Then by the chain rule,
$$u_x= \pdv{u}{x}=\pdv{u}{\eta}\pdv{\eta}{x}+\pdv{u}{\xi}\pdv{\xi}{x}=$$

$$\pdv{u}{\eta}+\pdv{u}{\xi}\left(-1-\frac{1}{x}\right) $$

Similarly, $$u_y=\pdv{u}{y}=2\pdv{u}{\xi}$$

Plugging into our initial PDE,
$$2xu_x+(x+1)u_y=2x\pdv{u}{\eta}+\pdv{u}{\xi}2x\left(-1-\frac{1}{x}\right)+2(x+1)\pdv{u}{\xi}=2x\pdv{u}{\eta}$$

And since we know $2xu_x+(x+1)u_y=y$, this means $y=2x\pdv{u}{\eta}$ or
$$\frac{\eta}{2}+\frac{\ln(\eta)}{2}+\xi=2\eta \pdv{u}{\eta}$$